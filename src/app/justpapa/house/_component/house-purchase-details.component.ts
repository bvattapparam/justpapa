...
@Component({
  selector: 'app-house-purchase-details',
  templateUrl: './house-purchase-details.component.html',
  styleUrls: ['./house-purchase-details.component.scss']
})
export class HousePurchaseDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getHousePaymentByHouseId(this.house);
  }
  getHousePaymentByHouseId(houseId: any){
    this.showSpinner = true;
    this.houseService.getHousePaymentByHouseId(houseId)
    .subscribe((resp: any) => {
      this.result = resp;
